...
//   return (
//     <section className="container mx-auto px-4 py-32 flex flex-col lg:flex-row gap-10 text-black lg:h-screen md:px-14">
...
//           <DialogContent className="fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90vw] h-[90vh] bg-white rounded-lg shadow-lg flex flex-col">
//             {/* Botão de Fechar Melhorado */}
//             <button
//               onClick={closeGallery}
//               className="absolute top-4 right-4 bg-black p-2 transition"
//               aria-label="Fechar"
//             ></button>

//             {/* Carousel Responsivo */}
//             <div className="flex-1 flex items-center justify-center p-14">
//               <Carousel className="w-full h-full flex items-center justify-center bg-red-500">
//                 <CarouselContent className="w-full h-full">
//                   {selectedProperty.gallery.map((image, index) => (
//                     <CarouselItem
//                       key={index}
//                       className="carousel-item flex justify-center items-center w-full h-full"
//                     >
//                       <Image
//                         src={image}
//                         alt={`Imagem ${index + 1}`}
